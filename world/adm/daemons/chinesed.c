...
string *c_digit = ({ "零","十","百","千","万","亿","兆" });
string *c_num = ({"零","一","二","三","四","五","六","七","八","九","十"});
string *sym_tien = ({ "甲","乙","丙","丁","戊","己","庚","辛","壬","癸" });
string *sym_dee = ({ "子","丑","寅","卯","辰","巳","午","未","申","酉","戌","亥" });

// mon 99/07/22
int pseudo_day, last_day=-1;
